...
public class HabilidadesBlandas {
    ...
    public HabilidadesBlandas(String trabajo_equipo, String pensamiento_critico, String comunicacion_asertiva, String escucha_activa, String adaptacion_cambio, String creatividad, String respeto_opiniones) {
